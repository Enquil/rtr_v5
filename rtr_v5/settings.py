"""
Django settings for rtr_v5 project.
...
# Tells django where to look for html templates
...
SECRET_KEY = (
    'django-insecure-3ixl4!j-0y@vcvq&(untljto1nipvw3o*)z4u=$&imp3+@+9cr'
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # categories context processor, see home app
...
# NOSE_ARGS = [
#     '--with-coverage',
#     '--cover-package=create_post,edit_post,home,post_detail,profiles,delete_actions',
# ]
